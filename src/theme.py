...
AUTHOR_NAME = 'Li Shen'
AUTHOR_AFFILIATION = 'Pricing analytics -> healthcare product management'
...
def _css() -> str:
    ...
    <style>
      ...
      .pe-intro .kicker {{
          ...
          font-size: 0.82rem; font-weight: 650; letter-spacing: 0;
      ...
      .pe-intro .tagline {{
          color: var(--text-muted); font-size: 1.08rem; line-height: 1.55;
          margin-bottom: 0.75rem;
      }}
      .pe-chips {{ display: flex; flex-wrap: wrap; gap: 0.5rem; }}
      .pe-chip {{
          font-size: 0.9rem; color: var(--text-muted);
          background: var(--surface-2); border: 1px solid var(--border);
          padding: 0.26rem 0.65rem; border-radius: 8px;
      }}

      /* --- Insight cards (full-width row block) --- */
      .pe-insight {{
          display: flex; flex-direction: column; gap: 0.45rem;
          padding: 1.15rem 1.25rem; border-radius: 8px;
          border: 1px solid var(--border); border-left-width: 3px;
          background: var(--surface-card); height: 100%;
      }}
      .pe-insight .label {{
          font-size: 0.78rem; letter-spacing: 0.06em; font-weight: 650;
      ...
      .pe-insight .detail {{
          font-size: 0.98rem; color: var(--text-muted); line-height: 1.55;
      }}
      ...
      /* --- Section header --- */
      .pe-section {{
          margin: 1.9rem 0 0.75rem 0; padding-bottom: 0.45rem;
          border-bottom: 1px solid var(--border);
      }}
      .pe-section .title {{ font-size: 1.25rem; font-weight: 650; color: var(--text); }}
      .pe-section .caption {{ font-size: 0.98rem; color: var(--text-muted); margin-top: 0.18rem; line-height: 1.55; }}
