...
display_names = {
    'product_id': 'Product',
    'store_id': 'Store',
    'quantity': 'Observed units',
    'price': 'Current price',
    'unit_cost': 'Unit cost',
    'promo': 'Current promo',
    'competitor_price': 'Competitor price',
    'cand_price': 'Action price',
    'cand_promo': 'Action promo',
    'cand_q': 'Action units',
    'cand_revenue': 'Action revenue',
    'baseline_profit': 'Do-nothing profit ($)',
    'cand_profit': 'Action profit ($)',
    'profit_lift_abs': 'Action lift ($)',
    'profit_lift_pct': 'Action lift (%)',
}
display = scored[display_cols].rename(columns=display_names)
st.dataframe(
