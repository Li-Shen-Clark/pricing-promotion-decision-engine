...
The app opens at `http://localhost:8501`. The sidebar lists seven entries: Overview, Evidence, Simulate, Optimize, Validate, Boundaries, Upload (full titles: Model Evidence, What-If Simulator, Candidate Finder, Test Planner, Trust & Boundaries, Upload & Score).
...
| `reports/*.md` (4 files) | ~30 KB | embedded in Trust & Boundaries + Test Planner tabs |
